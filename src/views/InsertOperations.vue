<template>
<div class="insert-operations-page" dir="rtl">
...
<button @click="showAddModal = true" class="btn-add-operation">
    إضافة عملية جديدة
</button>
...
<div v-if="showDeleteAllModal" class="modal-overlay">
    ...
    <div class="form-actions center">
        ...
        <button @click='() => { showDeleteAllModal = false ; deleteTechnicianUsername="" }' class='btn-cancel'>
        إلغاء
        </button>
    </div>
...
const { error } = await supabase.from('operations').insert([
{
    ...
    // افتراضياً timestamp يضاف تلقائياً من قاعدة البيانات لو تم ضبطه هناك
},
])
